...
class Filter(Node): """필터"""
class MapExpr(Node): """맵"""
class FoldExpr(Node): """리듀스"""
class SelectExpr(Node): """최대·최소"""
class QuantExpr(Node): """전체·존재 판정"""
class RecordLit(Node): """구조체 만들기"""
class SortSpec(Node): """정렬 기준"""
